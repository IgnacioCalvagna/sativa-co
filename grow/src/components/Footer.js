...
const Footer = () => {
  return (
    ...
    <footer className="row row-cols-5 py-5 my-5 border-top footer">
      <div className="col">
        <span className="d-flex align-items-center mb-3 logo-text">{'Sativa & Co'}</span>
      ...
      <div className="col">
        <h5>Combos</h5>
        <ul className="nav flex-column">
          <li className="nav-item mb-2">Picador</li>
          <li className="nav-item mb-2">Sedas</li>
          <li className="nav-item mb-2">Carpas y Lamparas</li>
          <li className="nav-item mb-2">Fertilizantes y Sanidad</li>
          <li className="nav-item mb-2">Masetas y Sustratos</li>
        </ul>
      </div>
      <div className="col">
        <h5>Nosotros</h5>
